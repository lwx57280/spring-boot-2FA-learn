...
import com.mate.cloud.googlecheck.utils.MultiFactorAuthenticator;
...
public class TestController {
     ...
     */
    @GetMapping("/bind")
    public Map<String, String> bind(@RequestParam("username") String username) {
        userSecret.put("username", username);
        ...
        if (userSecret.containsKey(username)) {
            ...
            log.info("========bind========={}", userSecret.toString());
            return json;
        }
